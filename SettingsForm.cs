...
namespace DisksizeWatcher
{
	...
	public partial class SettingsForm : Form
	{
		...
		public SettingsForm()
		{
			...
			{
				HandleException(ex: ex, message: "An error occurred while initializing the SettingsForm.");
			}
		}
		...
		private void SettingsForm_Load(object sender, EventArgs e)
		{
			...
			{
				HandleException(ex: ex, message: "An error occurred while loading the SettingsForm.");
			}
		}
